...
recognizer.read('C:\\Users\\R Jayani\\OneDrive\\Desktop\\Mini Project Face\\Project\\trainer.yml')
...
names = ['None','revanth','jayani']  

prototxtPath = r"C:\\Users\\R Jayani\\OneDrive\Desktop\\Mini Project Face\\Project\\deploy.prototxt"
weightsPath = r"C:\\Users\\R Jayani\\OneDrive\\Desktop\\Mini Project Face\\Project\\res10_300x300_ssd_iter_140000.caffemodel"
    ...
    for (box, pred) in zip(locs, preds):
        ...
        if(label == 'No Mask'):
            ...
            if(t == 20):
                ...
                dictionary={id:"+91 6303 153 052","revanth":"+91 91216 45380","jayani":"+91 7793958111"}
                hour = int(datetime.datetime.now().hour)
                mins = int(datetime.datetime.now().minute)
                pwt.sendwhatmsg(dictionary[id],"please wear the mask",hour,mins+2)
